...
mod tests {
    ...
    fn protocol_negotiates_within_major_only() {
        ...
        let previous_minor = ((PROTOCOL_MAJOR as u16) << 8) | 1;
        assert_eq!(negotiated_version(previous_minor), Some(previous_minor));
        ...
        assert_eq!(protocol_label(VERSION), "1.2");
    }
